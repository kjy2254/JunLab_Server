  ...
  axios
    ...
    .then((response) => {
      ...
      if (airQualityData.length > 0) {
        ...
        const { myreport, Tvoc, Co2, Pm10, Temperature, Pm25, Humid } =
          latestData;
        ...
        // 데이터베이스 삽입
        const query2 = `
            INSERT INTO airwall_data (sensor_module_id, factory_id, temperature, tvoc, co2, pm10, pm2_5, humid, timestamp)
            SELECT ?, factory_id, ?, ?, ?, ?, ?, ?, ?
            FROM airwall
            WHERE module_id = ?;`;
