...
function Login(props) {
  ...
  function postLogin() {
    ...
    fetch("http://junlab.postech.ac.kr:880/login/login", {
      //auth 주소에서 받을 예정
  ...
  function postSignUp() {
    ...
    fetch("http://junlab.postech.ac.kr:880/login/signup", {
      //signin 주소에서 받을 예정
      method: "post", // method :통신방법
      headers: {
        // headers: API 응답에 대한 정보를 담음
        ...
        <div className="login-html">
          ...
          <div className="login-form">
            <div className="sign-in-htm">
              ...
              <div className="group">
                <button type="submit" className="button" onClick={postLogin}>
                  {" "}
                  Sign In
                </button>
              </div>
            ...
            <div className="sign-up-htm">
              <div className="group">
                <label htmlFor="su_user" className="label">
                  Username
                </label>
                <input
                  id="su_user"
                  ...
                  className="input"
                  value={su_id}
                  onChange={updateSu_id}
                />
              </div>
              <div className="group">
                <label htmlFor="su_pass" className="label">
                  Password
                </label>
                <input
                  id="su_pass"
                  ...
                  datatype="password"
                  value={su_password}
                  onChange={updateSu_pw}
                />
              </div>
              <div className="group">
                <label htmlFor="su_pass2" className="label">
                  Repeat Password
                </label>
                <input
                  id="su_pass2"
                  ...
                  datatype="password"
                  value={su_password2}
                  onChange={updateSu_pw2}
                />
              </div>
              <div className="group">
                <label htmlFor="su_email" className="label">
                  Email Address
                </label>
                <input
                  id="su_email"
                  ...
                  className="input"
                  value={su_email}
                  onChange={updateSu_email}
                />
              </div>
              <div className="group">
                <button type="submit" className="button" onClick={postSignUp}>
                  {" "}
                  Sign Up
                </button>
              </div>
