      ...
      <div className="chart-info ">
        <div className="flex">
          ...
          <div className="chart-name-area">
            ...
            <div className="chart-subname">{chartSubname}</div>
          </div>
        </div>
        <div className="chart-value-area">
          <div className="chart-value">
            <div className="chart-value-num">{chartValue}</div>
            <div className="chart-value-unit">{chartUnit}</div>
          </div>
          <div
            className="chart-diff"
            style={{ color: chartDiff < 0 ? "#0653b0" : "" }}
          >
            {chartDiff >= 0
              ? `+${chartDiff.toFixed(2)}%`
              : `${chartDiff.toFixed(2)}%`}
