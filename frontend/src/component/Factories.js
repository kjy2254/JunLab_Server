                        ...
                        <Link className="factory-card" key={factory.factory_id} to={`/iitp/factoryManagement/factory/${factory.factory_id}`}>
                            ...
                            <div className="factory-details">
                                <div className="factory-item">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="22" viewBox="0 0 156 223"
                                         fill="none">
                                        <path
                                ...
                                <div className="factory-item">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 512 449" fill="none">
                                        <path d="M512 121V416.1C512 433.77 497.67 448.1 480 448.1H32C14.33 448.1 0 433.77 0 416.1V32.1C0 14.43 14.33 0.0999756 32 0.0999756H128C145.67 0.0999756 160 14.43 160 32.1V192.1L299.1 99.86C315.1 90.6 336 102.1 336 121V192.1L475.1 99.86C491.1 90.6 512 102.1 512 121Z" fill="black"/>
                                    </svg>&nbsp;&nbsp;
                                    {factory.industry}
                                </div>
                                <div className="factory-item">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 294 294"
                                         fill="none">
                                        <path
