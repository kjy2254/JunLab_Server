...
// api.get("/label/env", (req, res) => {
//   const query = `
//     SELECT x, w.worker_id, fake_name, age, gender, height, weight, illness, job, smoke, num_of_drink, employment_period, id
//     FROM env_df e
...
//         const parsedXData = JSON.parse(result[0].x);
...
api.get("/label/progress", (req, res) => {
...
// api.get("/label/health/:id", (req, res) => {
